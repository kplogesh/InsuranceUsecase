...
kubectl create configmap tn-data-load --from-file=ExportedData-$1.zip --from-file=assets/insurance/insurance-usecase-type-apigw-extes/applications/tradingnetworks/dev/sourcecode/tn-assets/consolidated/TNExport.xml
